...
#error Client version information missing: version is not defined by nodetrade-config.h or in any other way
#endif
...
/**
 * nodetraded-res.rc includes this file, but it cannot cope with real c++ code.
