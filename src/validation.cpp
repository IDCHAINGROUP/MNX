...
#if defined(NDEBUG)
#error "NODETRADE cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in umnx) are considered zero fee (for relaying, mining and transaction creation)
...
CAmount GetBlockValue(int nHeight)
{
    ...
    // Testnet high-inflation blocks [2, 200] with value 250k MNX
    ...
    if (nHeight == 1) {
        ...
        nSubsidy = 0.0005 * COIN;
    } else if (nHeight <= 50000) {
        nSubsidy = 0.0015 * COIN;
    } else if (nHeight <= 80000) {
        nSubsidy = 0.0040 * COIN;
    } else if (nHeight <= 110000) {
        nSubsidy = 0.0200 * COIN;
    } else if (nHeight <= 135000) {
        nSubsidy = 0.1000 * COIN;
    } else if (nHeight <= 150000) {
        nSubsidy = 0.0800 * COIN;
    } else if (nHeight <= 165000) {
        nSubsidy = 0.0600 * COIN;
    } else if (nHeight <= 180000) {
        nSubsidy = 0.0400 * COIN;
    } else if (nHeight <= 200000) {
        nSubsidy = 0.0200 * COIN;
    } else if (nHeight <= 220000) {
        nSubsidy = 0.0100 * COIN;
    } else if (nHeight <= 240000) {
        nSubsidy = 0.0090 * COIN;
    } else if (nHeight <= 260000) {
        nSubsidy = 0.0080 * COIN;
    } else if (nHeight <= 280000) {
        nSubsidy = 0.0070 * COIN;
    } else if (nHeight <= 285000) {
        nSubsidy = 0.0060 * COIN;
    } else if (nHeight <= 340000) {
        nSubsidy = 0.0050 * COIN;
    } else if (nHeight <= 380000) {
        nSubsidy = 0.0045 * COIN;
    } else if (nHeight <= 400000) {
        nSubsidy = 0.0040 * COIN;
    } else if (nHeight <= 440000) {
        nSubsidy = 0.0038 * COIN;
    } else if (nHeight <= 460000) {
        nSubsidy = 0.0035 * COIN;
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue)
{
    ...
    if (nHeight <= 1000) {
        ...
        mnSubsidy = 0.0004 * COIN;
    } else if (nHeight <= 50000) {
        mnSubsidy = 0.0014 * COIN;
    } else if (nHeight <= 80000) {
        mnSubsidy = 0.0039 * COIN;
    } else if (nHeight <= 110000) {
        mnSubsidy = 0.0199 * COIN;
    } else if (nHeight <= 135000) {
        mnSubsidy = 0.0999 * COIN;
    } else if (nHeight <= 150000) {
        mnSubsidy = 0.0799 * COIN;
    } else if (nHeight <= 165000) {
        mnSubsidy = 0.0599 * COIN;
    } else if (nHeight <= 180000) {
        mnSubsidy = 0.0399 * COIN;
    } else if (nHeight <= 200000) {
        mnSubsidy = 0.0199 * COIN;
    } else if (nHeight <= 220000) {
        mnSubsidy = 0.0099 * COIN;
    } else if (nHeight <= 240000) {
        mnSubsidy = 0.0089 * COIN;
    } else if (nHeight <= 260000) {
        mnSubsidy = 0.0079 * COIN;
    } else if (nHeight <= 280000) {
        mnSubsidy = 0.0069 * COIN;
    } else if (nHeight <= 285000) {
        mnSubsidy = 0.0059 * COIN;
    } else if (nHeight <= 340000) {
        mnSubsidy = 0.0049 * COIN;
    } else if (nHeight <= 380000) {
        mnSubsidy = 0.0044 * COIN;
    } else if (nHeight <= 400000) {
        mnSubsidy = 0.0039 * COIN;
    } else if (nHeight <= 440000) {
        mnSubsidy = 0.0037 * COIN;
    } else if (nHeight <= 460000) {
        mnSubsidy = 0.0034 * COIN;
    } else if (nHeight <= 500000) {
        mnSubsidy = 0.03 * COIN;
    } else if (nHeight <= 600000) {
        mnSubsidy = 0.4 * COIN;
...
int64_t GetDevrewardValue(int nHeight)
{
    int64_t nAmount = 0;

    if (nHeight >= Params().GetConsensus().nTreasuryStartHeight && nHeight <= 500000) {
        nAmount = 0.003 * COIN; // Dev Reward
    } else if (nHeight >= 500001 && nHeight <= 600000) {
        nAmount = 0.078 * COIN;   
    } else if (nHeight >= 600001 && nHeight <= 710000) {
        nAmount = 0.40 * COIN;
    } else if (nHeight >= 710001 && nHeight <= 920000) {
        nAmount = 0.50 * COIN;
    } else if (nHeight == 920001) {
        nAmount = 4000000 * COIN;
    } else if (nHeight >= 920002 && nHeight <= 1000000) {
        nAmount = 0.25 * COIN;
    } else if (nHeight >= 1000001 && nHeight <= 1020000) {
        nAmount = 2 * COIN;
    } else if (nHeight >= 1020001 && nHeight <= 1050000) {
        nAmount = 2 * COIN;
    } else if (nHeight >= 1050001 && nHeight <= 1100000) {
        nAmount = 1.25 * COIN;
    } else if (nHeight >= 1100001 && nHeight <= 1150000) {
        nAmount = 1 * COIN;
    } else {
        nAmount = 2 * COIN;
    }
...
{
    util::ThreadRename("nodetrade-scriptch");
...
static bool ConnectBlock(const CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool fJustCheck = false)
{
    ...
    const Consensus::Params& consensus = Params().GetConsensus();
    const bool isPoSActive = consensus.NetworkUpgradeActive(pindex->nHeight - 1, Consensus::UPGRADE_POS);
...
bool CheckColdStakeFreeOutput(const CTransaction& tx, const int nHeight)
{
    ...
    const CTxOut& secondLastOut = tx.vout[outs - 2];
    if (outs >=3 && lastOut.scriptPubKey != tx.vout[outs-2].scriptPubKey) {
        ...
        CAmount devrewardvalue = GetDevrewardValue(nHeight);


        if (nHeight > Params().GetConsensus().nTreasuryStartHeight) {
            if (secondLastOut.nValue == masternodePayment && lastOut.nValue == devrewardvalue)
                return true;
        } else {
...
bool CheckWork(const CBlock& block, const CBlockIndex* const pindexPrev)
{
    ...
    if (block.nBits != nBitsRequired) {
        // Nodetrade Specific reference to the block with the wrong threshold was used.
        const Consensus::Params& consensus = Params().GetConsensus();
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex* const pindexPrev)
{
    ...
    if ((block.nVersion < 3 && nHeight >= 1) ||
        ...
        (block.nVersion < 6 && consensus.NetworkUpgradeActive(nHeight, Consensus::UPGRADE_V4_0)) ||
...
/*
 * Collect the sets of the inputs (either regular utxos ) spent
 * by in-block txes.
