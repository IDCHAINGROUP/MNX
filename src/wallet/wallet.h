...
#ifndef NODETRADE_WALLET_H
#define NODETRADE_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_NODETRADE = 61000, // inherited version..
...
public:
    ...
    static const CAmount DEFAULT_STAKE_SPLIT_THRESHOLD = 100 * COIN;
     ...
     * NODETRADE: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 MNX output and keys which can be used for the Masternode
