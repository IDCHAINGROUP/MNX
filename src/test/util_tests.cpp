...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("nodetrade"), "Nodetrade");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://nodetrade.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/nodetrade"));
    BOOST_CHECK(validateURL("https://foo.bar/nodetrade/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.nodetrade.com"));
