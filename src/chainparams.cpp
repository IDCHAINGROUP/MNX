...
{
    const char* pszTimestamp = "Netanyahu misses deadline to build a new government";
...
static MapCheckpoints mapCheckpoints = {
    {0, uint256S("00000c8929396993a29af5b645f14b595102ce91bd9e238c20368ff184f8a5ad")},
    {142503, uint256S("62c02c699d5fdbe222b017138388d3c02bb4ae9945c731987c5d93c9a41fef3a")},
    {245409, uint256S("b3d0dafaf64ce0b8a42e900bf25882637e43d093302b427f60eb7579e161fb9f")},
    {340250, uint256S("f67628a4e85f0998d59a7664127f791d80a285152a2eba37b67e8c8263bfd2ac")},
    {423566, uint256S("2eb8e8a0f72d535b241f921444f4c2b6f7efb444dd210248711f7e452c27cd3f")},
    {429950, uint256S("384cfaa540040b6ef9beb5409dd7385221708ff936a1a629fa35125e9a1d17f6")},
    ...
    {811150, uint256S("2efc5913aa4580e2583098463e3a178045b6ee72a6548d5b2eb42ae6615bd7e7")},
    {811154, uint256S("990581901e121c53da1ec94991987ae6a369ecd1e021b2746554d556ae7311ba")},
    {811155, uint256S("27062c05ead0d5062fb20c94853b0f42000e9bfd7e348bec614ddc322a2178ff")},
    {811160, uint256S("bb51b6636ef743308808bebdd90c25b761bc97d979ffef4a940a046bb24b0830")},
    {815127, uint256S("f2410074365f1212bb6b5b57cf5c91d2f883b7d27b5f45b6a062394151d558c1")},
    {816109, uint256S("e7855d1ac03a8f05210dd985dc8b90d9a7ea7ddefe82fd1a39283b186364b901")},
    {816387, uint256S("e87621399b61419c3f0af0d10d897e58ade42b06e28e25738eb1d72f14f7fa29")},
    {816507, uint256S("bc9a0355a3954d19aff64d40720aed601ba661715d8d0d78298d7fa813e11f77")},
    {816800, uint256S("13662685daa2dadc191cf84c4d95178e151efd8296e3157262244dcb3bdd0eaa")},
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1620204574, 132127, 0x1e0ffff0, 1, 0.00000050 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("00000c8929396993a29af5b645f14b595102ce91bd9e238c20368ff184f8a5ad"));
        assert(genesis.hashMerkleRoot == uint256S("15467b26634603ac7252d4a10837a15db575ecaecda1c435449430251185870a"));
        ...
        consensus.nStakeMinAmount = 10 * COIN;
        consensus.height_start_StakeMinAmountEnforcement = 440000; //minimum stake amount activation height
        ...
        consensus.vUpgrades[Consensus::UPGRADE_POS_V2].nActivationHeight = 10000;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_V4_0].nActivationHeight = 1030;
        consensus.vUpgrades[Consensus::UPGRADE_V5_0].nActivationHeight = 440000;   //shielded activation height
        consensus.vUpgrades[Consensus::UPGRADE_V5_2].nActivationHeight = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        ...
        vSeeds.emplace_back("45.76.9.162", true);
        ...
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 75);     // starting with 'X'
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "mnxks";
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("nodetrade-testnet.seed.fuzzbawls.pw", true);
        vSeeds.emplace_back("nodetrade-testnet.seed2.fuzzbawls.pw", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet nodetrade addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet nodetrade script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet nodetrade BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = {0x3a, 0x80, 0x61, 0xa0};
        // Testnet nodetrade BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = {0x3a, 0x80, 0x58, 0x37};
        // Testnet nodetrade BIP44 coin type is '1' (All coin's testnet default)
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "mnxktestsapling";
