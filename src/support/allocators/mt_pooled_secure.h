...
#ifndef NODETRADE_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
#define NODETRADE_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
...
#endif // NODETRADE_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
