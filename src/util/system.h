...
extern const char * const NODETRADE_CONF_FILENAME;
extern const char * const NODETRADE_PID_FILENAME;
extern const char * const NODETRADE_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("nodetrade-%s", name);
