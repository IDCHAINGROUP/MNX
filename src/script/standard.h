 ...
 *  A CTxDestination is the internal data type encoded in a NODETRADE address
 */
...
/**
 * Generate a NODETRADE scriptPubKey for the given CTxDestination. Returns a P2PKH
