...
/** Utility functions used by the NODETRADE Qt UI.
 */
namespace GUIUtil
{
...
// Render NODETRADE addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZmnx = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZmnx = false);
...
// Parse "nodetrade:" URI into recipient object, return true on successful parsing
