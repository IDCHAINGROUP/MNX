...
#ifndef NODETRADE_CORE_NEW_GUI_NODETRADEGUI_H
#define NODETRADE_CORE_NEW_GUI_NODETRADEGUI_H
...
#include "qt/nodetrade/navmenuwidget.h"
#include "qt/nodetrade/topbar.h"
#include "qt/nodetrade/dashboardwidget.h"
#include "qt/nodetrade/send.h"
#include "qt/nodetrade/receivewidget.h"
#include "qt/nodetrade/addresseswidget.h"
#include "qt/nodetrade/coldstakingwidget.h"
#include "qt/nodetrade/governancewidget.h"
#include "qt/nodetrade/masternodeswidget.h"
#include "qt/nodetrade/snackbar.h"
#include "qt/nodetrade/settings/settingswidget.h"
...
/**
  NODETRADE GUI main class. This class represents the main window of the NODETRADE UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class NODETRADEGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit NODETRADEGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~NODETRADEGUI();
...
#endif //NODETRADE_CORE_NEW_GUI_NODETRADEGUI_H
