...
#include "qt/nodetrade/createproposaldialog.h"
#include "qt/nodetrade/forms/ui_createproposaldialog.h"

#include "qt/nodetrade/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(NODETRADEGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.nodetrade/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 MNX");
...
void CreateProposalDialog::onAddrListClicked()
{
    ...
    if (!menuContacts) {
        ...
        menuContacts = new ContactsDropdown(
                width,
                height,
                dynamic_cast<NODETRADEGUI*>(parent()),
                this
        );
