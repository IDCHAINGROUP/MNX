...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, NODETRADEGUI* gui, double posX = 3, int posY = 5, bool hideOpaqueBackground = true);
bool openDialogWithOpaqueBackground(QDialog* widget, NODETRADEGUI* gui, double posX = 3);
