...
#include "qt/nodetrade/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/nodetrade/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(NODETRADEGUI* _window, QWidget *parent) :
