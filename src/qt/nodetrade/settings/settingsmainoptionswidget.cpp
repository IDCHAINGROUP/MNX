...
#include "qt/nodetrade/settings/forms/ui_settingsmainoptionswidget.h"
#include "QListView"
...
SettingsMainOptionsWidget::SettingsMainOptionsWidget(NODETRADEGUI* _window, QWidget *parent) :
