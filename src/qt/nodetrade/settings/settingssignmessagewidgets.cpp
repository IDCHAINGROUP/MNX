...
#include "qt/nodetrade/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(NODETRADEGUI* _window, QWidget *parent) :
