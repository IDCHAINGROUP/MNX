...
#include <QWidget>
#include "qt/nodetrade/pwidget.h"
#include "qt/nodetrade/settings/settingsbackupwallet.h"
#include "qt/nodetrade/settings/settingsexportcsv.h"
#include "qt/nodetrade/settings/settingsbittoolwidget.h"
#include "qt/nodetrade/settings/settingssignmessagewidgets.h"
#include "qt/nodetrade/settings/settingswalletrepairwidget.h"
#include "qt/nodetrade/settings/settingswalletoptionswidget.h"
#include "qt/nodetrade/settings/settingsmainoptionswidget.h"
#include "qt/nodetrade/settings/settingsdisplayoptionswidget.h"
#include "qt/nodetrade/settings/settingsinformationwidget.h"
#include "qt/nodetrade/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(NODETRADEGUI* parent);
    ~SettingsWidget();
