...
#include "qt/nodetrade/settings/forms/ui_settingsinformationwidget.h"
...
SettingsInformationWidget::SettingsInformationWidget(NODETRADEGUI* _window,QWidget *parent) :
