...
#include "qt/nodetrade/settings/settingsnetworkwidget.h"
#include "qt/nodetrade/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/nodetrade/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(NODETRADEGUI* _window, QWidget *parent) :
