...
#include "qt/nodetrade/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/nodetrade/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(NODETRADEGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to NODETRADEGUI::handleRestart()
