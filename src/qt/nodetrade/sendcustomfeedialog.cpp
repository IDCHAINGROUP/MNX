...
#include "qt/nodetrade/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(NODETRADEGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &NODETRADEGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
