...
#ifndef NODETRADE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define NODETRADE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //NODETRADE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
