...
#include "qt/nodetrade/contactdropdownrow.h"
...
ContactsDropdown::ContactsDropdown(int minWidth, int minHeight, NODETRADEGUI* _window, QWidget* _parent) : PWidget(_window, _parent)
{
