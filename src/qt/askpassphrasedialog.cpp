...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            NODETRADEGUI* window = static_cast<NODETRADEGUI*>(parentWidget());
...
{
    NODETRADEGUI* gui = static_cast<NODETRADEGUI*>(parentWidget());
...
{
    hide();
    static_cast<NODETRADEGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("%1 will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your MNXs from being stolen by malware infecting your computer.").arg(PACKAGE_NAME) +
            "<br><br><b>" +
