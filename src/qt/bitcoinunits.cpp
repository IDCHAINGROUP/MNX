...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MNX);
    unitlist.append(mMNX);
    unitlist.append(uMNX);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case MNX:
        return QString("nodetrade");
    case mMNX:
        return QString("mnodetrade");
    case uMNX:
        return QString::fromUtf8("unodetrade");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZmnx)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZMNX)
{
    QSettings settings;
...
QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZMNX)
{
