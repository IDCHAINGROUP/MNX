...
// Copyright (c) 2016-2020 The NODETRADE developers
...
public:
    ...
    /**
     * Amount of nodetrade coming in to a transaction
    ...
    /*
     * Prune frozen outputs - do it once, after initialization
     */
...
// NODETRADE: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
