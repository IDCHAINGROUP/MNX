...
class NODETRADE_ColdStakingTest(NodetradeTestFramework):
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 MNX from the pot)
...
if __name__ == '__main__':
    NODETRADE_ColdStakingTest().main()
