...
class DIP3Test(NodetradeTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 MNX) to the operator, and (2 * 2.7 MNX) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid NODETRADE address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid NODETRADE address InvalidPayee", controller.protx_update_registrar,
