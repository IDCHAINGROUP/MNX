...
# Copyright (c) 2020-2021 The NODETRADE developers
...
class FullBlockTest(NodetradeTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure nodetraded isn't accepting b26
        ...
        # Extend the b28 chain to make sure nodetraded isn't accepting b28
        ...
        # NODETRADE: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the nodetrade code has custom code which does so);
