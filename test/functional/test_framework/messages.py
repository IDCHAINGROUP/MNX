...
COIN = 100000000 # 1 MNX in satoshis
...
# Objects that map to nodetraded objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in nodetraded indicates these should be deserialized as blocks
