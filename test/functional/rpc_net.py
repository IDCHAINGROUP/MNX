...
class NetTest(NodetradeTestFramework):
    ...
    def _test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(ipv6_addr, 12689)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 12689)
