...
By default, nodetraded will dump mempool on shutdown and
...
class MempoolPersistTest(NodetradeTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent nodetraded from writing mempool.dat to disk. Verify that `savemempool` fails")
