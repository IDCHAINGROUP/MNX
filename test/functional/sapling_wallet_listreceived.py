...
class ListReceivedTest (NodetradeTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 MNX.
        ...
        # Send 1 MNX to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 MNX sending them all (fee is 0.1 MNX)
        ...
        # Confirm transaction (2 MNX from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 MNX, send 0.6 MNX + 0.05 MNX fee
