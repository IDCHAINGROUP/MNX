...
from test_framework.test_framework import NodetradeTier2TestFramework
...
class MasternodeGovernanceBasicTest(NodetradeTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposal = Proposal(
            "super-cool",
            "https://forum.nodetrade.org/t/test-proposal",
            2,
        ...
        for entry in ['chainstate', 'blocks', 'sporks', 'evodb', "mncache.dat", "budget.dat", "mnpayments.dat", "peers.dat"]:
