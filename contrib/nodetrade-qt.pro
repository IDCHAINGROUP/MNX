...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/nodetrade-cli.cpp \
           src/nodetrade-tx.cpp \
           src/nodetrade.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/nodetrade.qrc src/qt/nodetrade_locale.qrc

TRANSLATIONS += src/qt/locale/nodetrade_bg.ts \
                src/qt/locale/nodetrade_de.ts \
                src/qt/locale/nodetrade_en.ts \
                src/qt/locale/nodetrade_es.ts \
                src/qt/locale/nodetrade_fi.ts \
                src/qt/locale/nodetrade_fr.ts \
                src/qt/locale/nodetrade_it.ts \
                src/qt/locale/nodetrade_ja.ts \
                src/qt/locale/nodetrade_pl.ts \
                src/qt/locale/nodetrade_pt.ts \
                src/qt/locale/nodetrade_ru.ts \
                src/qt/locale/nodetrade_sk.ts \
                src/qt/locale/nodetrade_sv.ts \
                src/qt/locale/nodetrade_vi.ts \
                src/qt/locale/nodetrade_zh_CN.ts \
                src/qt/locale/nodetrade_zh_TW.ts
