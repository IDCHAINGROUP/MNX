Contributing to NODETRADE
============================

The NODETRADE project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/nodetrade-project/nodetrade/blob/master/doc/translation_process.md)
...
The following applies to code changes to the NODETRADE project, and is not to be
confused with overall NODETRADE Network Protocol consensus changes.

Whether a pull request is merged into NODETRADE rests with the project merge
...
Patches that change NODETRADE consensus rules are considerably more involved than
...
Where a patchset proposes to change the NODETRADE consensus, it must have been
...
The project leader is the release manager for each NODETRADE release.
