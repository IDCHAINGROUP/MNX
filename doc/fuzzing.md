...
To build NODETRADE using AFL instrumentation (this assumes that the
...
with certain assembly code from NODETRADE's code. See [developer notes on sanitizers](https://github.com/NODETRADE-Project/NODETRADE/blob/master/doc/developer-notes.md#sanitizers)
