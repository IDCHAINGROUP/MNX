...
The build script we'll be using is contained in the NODETRADE github repository ([contrib/gitian-build.py](https://github.com/nodetrade-project/nodetrade/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the NODETRADE repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/NODETRADE-Project/NODETRADE/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, nodetrade-detached-sigs, and nodetrade GitHub repos.
